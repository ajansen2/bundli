        ...
        <div className="max-w-lg w-full">
          <div className="bg-gradient-to-br from-emerald-500/20 to-green-500/20 border-2 border-emerald-500/50 rounded-2xl p-8 text-center">
            ...
            <p className="text-white/70 mb-6 text-lg">
              Your 7-day free trial has expired. Subscribe to Bundli to continue creating product bundles.
            </p>
            <div className="bg-zinc-900/50 rounded-xl p-4 mb-6">
              <div className="text-white/60 text-sm mb-1">Bundli Pro</div>
              <div className="text-3xl font-bold text-white">$19.99<span className="text-lg font-normal text-white/60">/month</span></div>
              <div className="text-emerald-400 text-sm mt-1">Unlimited bundles & AI suggestions</div>
            </div>
            <button
