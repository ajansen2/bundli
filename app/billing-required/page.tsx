  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      if (data.confirmationUrl) {
        // Use App Bridge to redirect (breaks out of iframe properly)
    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6">
      <div className="text-center p-8 max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl">
        ...
        <p className="text-zinc-400 mb-6">
          Your free trial has ended. Subscribe to continue using Bundle Manager Pro.
        </p>
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {loading ? (
